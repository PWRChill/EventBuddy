...
class RealmAdapter {
    ...
    static func setupData(handler: () -> Void) {
        ...
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Multikino", image: "Multikino", address: "plac Grunwaldzki 22, 50-363 Wrocław", desc: nil, lat: 51.112686, lon: 17.059022, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Kino Cinema City Korona", image: "KinoCinemaCityKorona", address: "Bolesława Krzywoustego 126C, 50-001 Wrocław", desc: nil, lat: 51.141726, lon: 17.088214, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Wrocławski Teatr Piosenki", image: "WrocławskiTeatrPiosenki", address: "Jana Brzechwy 66, 51-141 Wrocław", desc: nil, lat: 51.142055, lon: 17.045812, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "DKF Politechnika. Kino", image: "DKFPolitechnikaKino", address: "wybrzeże Stanisława Wyspiańskiego 27, 48-387 Wrocław", desc: nil, lat: 51.107700, lon: 17.062614, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Helios", image: "Helios", address: "Kazimierza Wielkiego 19A, 11-400 Wrocław", desc: "cinema", lat: 51.109442, lon: 17.026337, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Kino Warszawa", image: "KinoWarszawa", address: "marsz. Józefa Piłsudskiego 64A, 11-400 Wrocław", desc: "cinema", lat: 51.107885, lon: 17.038538, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Multikino", image: "Multikino", address: "Arkady, Powstańców Śląskich 2-4, 11-400 Wrocław", desc: "cinema", lat: 51.099323, lon: 17.028845, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Kino 5D Extreme", image: "Kino5DExtreme", address: "Legnicka 58, 54-204 Wrocław", desc: "cinema 5D", lat: 51.118891, lon: 16.988989, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Helios", image: "Helios", address: "Magnolia Park, Legnicka 58, 54-204 Wrocław", desc: "cinema", lat: 51.118891, lon: 16.988989, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Centrum Inicjatyw Artystycznych", image: "CentrumInicjatywArtystycznych", address: "Sienkiewicza 8a, 50-335 Wrocław", desc: "Theatre", lat: 51.118250, lon: 17.044287, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Teatr Na Bruku", image: "TeatrNaBruku", address: "Kleczkowska 9, 50-227 Wrocław", desc: "Theatre", lat: 51.126710, lon: 17.033677, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Instytut im. Jerzego Grotowskiego, Studio Na Grobli", image: "StudioNaGrobli", address: "ul. 32,, Na Grobli 30, Wrocław", desc: "Theatre", lat: 51.103179, lon: 17.064584, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Teatr Piosenki", image: "TeatrPiosenki", address: "Mazowiecka 17, 11-400 Wrocław", desc: "Theatre", lat: 51.107539, lon: 17.050893, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "PSE Narodowy Teatr Edukacji", image: "PSENarodowyTeatrEdukacji", address: "Hauke Bosaka 11, 50-447 Wrocław", desc: "Theatre", lat: 51.105038, lon: 17.045135, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Teatr Pieśń Kozła / Song of the Goat Theatre", image: "TeatrPieśńKozła", address: "Jana Ewangelisty Purkyniego 1, 50-155 Wrocław", desc: "Theatre", lat: 51.110681, lon: 17.039611, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Instytut im. Jerzego Grotowskiego", image: "StudioNaGrobli", address: "Ratusz 27, 11-400 Wrocław", desc: "Theatre", lat: 51.110032, lon: 17.032793, rank: 0))
        entertainments.add(model: SingularObjectModel.singularObjectModel(name: "Wrocławski Teatr Współczesny im. Edmunda Wiercińskiego", image: "WrocławskiTeatrWspółczesny", address: "Rzeźnicza 12, 11-400 Wrocław", desc: "Theatre", lat: 51.112226, lon: 17.028961, rank: 0))
